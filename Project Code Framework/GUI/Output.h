...
public:
	...
	void DrawSwitch(GraphicsInfo r_GfxInfo, bool selected = false, bool sim = false) const;
	void DrawLED(GraphicsInfo r_GfxInfo, bool selected = false, bool sim=false) const;
	///TODO: Make similar functions for drawing all other gates, switch, and LED, .. etc
